...
//计算结点的 h 值  f=g+h. 按照将牌不在位的距离和进行计算 (曼哈顿距离)
/*
int computeHValue(PNode theNode)  
{  
    int num = 0;  
...
{  
    ...
    {  
        cout << endl;  
        cout << "len of Best Path = " << tmpNode->gvalue << endl;
